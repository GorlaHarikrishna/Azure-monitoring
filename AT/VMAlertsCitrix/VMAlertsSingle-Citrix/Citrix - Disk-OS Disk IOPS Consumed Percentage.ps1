...
# Define variables
$alertRuleNamePrefix = "Citrix - VM - Disk - OS Disk IOPS Consumed Percentage - azm "
...
foreach ($vm in $vms)
{
    ...
    $condition = New-AzMetricAlertRuleV2Criteria -MetricName "OS Disk IOPS Consumed Percentage" -TimeAggregation "maximum" -Operator "GreaterThan" -Threshold 99
